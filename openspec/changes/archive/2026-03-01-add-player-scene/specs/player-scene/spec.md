...
Player scene adalah CharacterBody3D-based entity yang merepresentasikan pemain di dunia 3D dengan HD-2D visual style menggunakan Sprite3D billboard.
...
- `player-movement` (Phase 1.3) - Movement script untuk player
- `player-aiming` (Phase 1.4) - Mouse aiming system
- `player-combat` (Phase 3.1) - Shooting mechanics
- `player-dash` (Phase 3.5) - Dash dengan i-frames
