...
Provides on-screen health display, damage feedback overlay, and death screen. Enables the player to understand their health state and provides restart capability on death.
...
- **Depends on**: health-system (health_changed signal, get_health_percent)
- **Depends on**: combat-vfx (Events.player_damaged, Events.player_died)
- **Related**: crosshair-ui (existing HUD that this extends)
